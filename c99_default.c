...
const char* product_name_string   = "C99 test";
...
{
	dac_input[0] = usb_input[0] = usb_output[0]/2 + adc_output[0]/2;
	dac_input[1] = usb_input[1] = usb_output[1]/2 + adc_output[1]/2;
	
	//dac_input[0] = usb_output[0];
	//usb_input[0] = usb_input[1] = adc_output[0]/2 - adc_output[1]/2;
}
