...
static int master_volume = 0, master_tone = 0, tone_level = 0;

int tone_coeffs[15][4] = // Fc = 0.001*(1.22^n), 1<=n<=15
{
    { FQ(1/2.619084652e+02), FQ(1/2.619084652e+02), FQ(-0.9923637443), 0 },
    { FQ(1/2.148588863e+02), FQ(1/2.148588863e+02), FQ(-0.9906915649), 0 },
    { FQ(1/1.762935451e+02), FQ(1/1.762935451e+02), FQ(-0.9886552851), 0 },
    { FQ(1/1.446824724e+02), FQ(1/1.446824724e+02), FQ(-0.9861766255), 0 },
    { FQ(1/1.187715897e+02), FQ(1/1.187715897e+02), FQ(-0.9831609562), 0 },
    { FQ(1/9.753295683e+01), FQ(1/9.753295683e+01), FQ(-0.9794941109), 0 },
    { FQ(1/8.012399213e+01), FQ(1/8.012399213e+01), FQ(-0.9750386876), 0 },
    { FQ(1/6.585404479e+01), FQ(1/6.585404479e+01), FQ(-0.9696298078), 0 },
    { FQ(1/5.415699560e+01), FQ(1/5.415699560e+01), FQ(-0.9630703296), 0 },
    { FQ(1/4.456879768e+01), FQ(1/4.456879768e+01), FQ(-0.9551255563), 0 },
    { FQ(1/3.670906671e+01), FQ(1/3.670906671e+01), FQ(-0.9455175470), 0 },
    { FQ(1/3.026599036e+01), FQ(1/3.026599036e+01), FQ(-0.9339192283), 0 },
    { FQ(1/2.498395793e+01), FQ(1/2.498395793e+01), FQ(-0.9199486324), 0 },
    { FQ(1/2.065341971e+01), FQ(1/2.065341971e+01), FQ(-0.9031637362), 0 },
    { FQ(1/1.710257356e+01), FQ(1/1.710257356e+01), FQ(-0.8830585354), 0 },
};
int tone_stateL[2] = {0,0}, tone_stateR[2] = {0,0};
                ...
                const int property[6] )
{
    ...
    i2s_input[0] = dsp_iir1(i2s_input[0],tone_coeffs[tone_level],tone_stateL) * 8; // Left
    i2s_input[1] = dsp_iir1(i2s_input[1],tone_coeffs[tone_level],tone_stateR) * 8; // Right
